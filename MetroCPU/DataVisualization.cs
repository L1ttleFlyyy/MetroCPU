...
namespace MetroCPU
{
    class Sensor2LineGraph
    {
        ...
        private int WindowWidth, N_capacity;
        ...
        public Sensor2LineGraph(Sensor s, LineGraph l, string dataFormat, double o, double h, TransitionText currentTB, TextBlock maxTB, TextBlock minTb)
        {
            ...
            sensor = s;
            lineGraph = l;
            N_capacity = s.MaxCapacity;
            WindowWidth = (N_capacity - 1) * Multiplier + 1;
            Point_x = new List<float>(N_capacity * Multiplier + 1);
            Point_y = new List<float>(N_capacity * Multiplier + 1);
            x_actual = new List<float>(N_capacity + 1);
            y_actual = new List<float>(N_capacity + 1);
