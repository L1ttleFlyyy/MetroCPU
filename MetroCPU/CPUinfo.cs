    ...
    class CPUinfo
    {
        ...
        public CPUinfo()
        {
            ...
            else
            {
                ...
                uint eax = 0, edx = 0;
                HWP_support = BitsSlicer(cpuid[6, 0], 7, 7) > 0;
                SST_support = _ols.Rdmsr(0x770, ref eax, ref edx) > 0 ? true : false;
            }
        }
        ...
        public bool SST_enabled
        {
            ...
            {
                if (value)
                    _ols.Wrmsr(0x770, 1, 0);
                else
                    _ols.Wrmsr(0x770, 0, 0);
            }
        }
